...
class Plumrocket_Cartreservation_Block_Checkout_Cart_Item_Renderer_Downloadable 
    extends Plumrocket_Cartreservation_Block_Checkout_Cart_Item_Renderer
{
    /*
	 * Function with reserved check defined in parent class 
	 */
