...
class Fontis_GoogleTagManager_Model_Source_Attributes_Categories extends Fontis_GoogleTagManager_Model_Source_Attributes_Abstract
{
    /**
     * @var string
     */
    protected $_eavCode = 'catalog_category';
    ...
    {
        return array(
            array('position' => 0, 'label' => 'Minimum Price (minimum_price)', 'value' => 'minimum_price'),
            array('position' => 0, 'label' => 'Product Count (product_count)', 'value' => 'product_count'),
        );
    }
}
