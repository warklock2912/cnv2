...
class Cybersource_Cybersource_Model_ApplePay_Api_Result_Refund extends Cybersource_Cybersource_Model_ApplePay_Api_Result_AbstractResult
{
    ...
    /**
     * Get the currency code from the result
     *
     * @return string
     */
