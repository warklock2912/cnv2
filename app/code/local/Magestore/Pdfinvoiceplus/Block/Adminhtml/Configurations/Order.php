 ...
 */
class Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_Order extends Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_Checkbox
{
    /**
     * Options getter
     *
    ...
    public function toOptionArray() {
        ...
        $all_var = $var_model->getAllVars_Order();
        $onHiden_Var = $var_model->getVarsOnHiden_Order();
        $mathVar = array();
