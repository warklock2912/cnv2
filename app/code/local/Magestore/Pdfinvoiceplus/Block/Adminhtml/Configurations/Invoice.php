 ...
 */
class Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_Invoice extends Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_Checkbox
{
    /**
     * Options getter
     *
    ...
    public function toOptionArray() {
        ...
        $all_var = $var_model->getAllVars_Invoice();
        $onHiden_Var = $var_model->getVarsOnHiden_Invoice();
        $mathVar = array();
