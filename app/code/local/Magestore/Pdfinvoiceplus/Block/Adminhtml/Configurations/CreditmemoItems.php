 ...
 */
class Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_CreditmemoItems extends Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_Checkbox
{
    /**
     * Options getter
     *
    ...
    public function toOptionArray() {
        ...
        $all_var = $var_model->getAllVars_Creditmemo_Items();
        $onHiden_Var = $var_model->getVarsOnHiden_Creditmemo_Items();
        $mathVar = array();
