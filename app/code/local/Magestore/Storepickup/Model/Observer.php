        ...
        try {
            ...
            if ($store) {
                ...
                if ($latitude != 0 && $longitude != 0) {
                    $shippingdesct .= '<br/><img src="http://maps.google.com/maps/api/staticmap?center='. $latitude . ',' . $longitude . '&zoom=14&size=550x200&markers=color:red|label:S|' . $latitude . ',' . $longitude.' "/><br/>';
                }
            }
