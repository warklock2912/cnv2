...
class Magestore_RewardPoints_Model_Observer
{
    ...
    public function salesOrderPlaceAfter($observer)
    {
        ...
        Mage::helper('rewardpoints')->logOrderReward("========== ORDER LOG ==========");
        Mage::helper('rewardpoints')->logOrderReward("Point Earn: " .$order->getRewardpointsEarn());
        Mage::helper('rewardpoints')->logOrderReward("Created At: " .$order->getCreatedAt());
        Mage::helper('rewardpoints')->logOrderReward("Increment Id: " .$order->getIncrementId());
        Mage::helper('rewardpoints')->logOrderReward("========== END ==========");
