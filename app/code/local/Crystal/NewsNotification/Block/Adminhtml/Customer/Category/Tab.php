...
class Crystal_NewsNotification_Block_Adminhtml_Customer_Category_Tab
	...
	implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
	...
	{
		parent::__construct();
		$this->setId('customer_edit_tab_newsnotification_category');
	}
	...
	{
		return $this->__('News Notification Categories');
	}
	...
	protected function _prepareCollection()
	{
		...
		$collection = Mage::getModel('mpblog/category')->getCollection()
			...
			->addFieldToFilter('category_for_app', 1);
