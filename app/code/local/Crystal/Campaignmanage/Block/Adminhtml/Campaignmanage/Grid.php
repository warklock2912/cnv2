...
class Crystal_Campaignmanage_Block_Adminhtml_Campaignmanage_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	public function __construct()
	{
		parent::__construct();
		$this->setId('campaignmanageGrid');
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('action', array(
			...
			'type' => 'action',
			'getter' => 'getId',
			'actions' => array(array('caption' => Mage::helper('dealerlocator')->__('Show Campaigns'), 'url' => array('base' => '*/campaign'), 'field' => 'id')),
			'filter' => FALSE,
			'sortable' => FALSE,
			'index' => 'stores',
			'is_system' => TRUE,
	...
	protected function _prepareMassaction()
	{
		...
		$this->getMassactionBlock()->addItem('status', array(
			...
			'additional' => array('visibility' => array('name' =>
				'status', 'type' =>
				'select', 'class' => 'required-entry',
				'label' => Mage::helper('dealerlocator')->__('Status'), 'values' => $statuses)
			)
		));
		return $this;
	}
	...
	{
		return $this->getUrl('*/campaign', array('id' => $row->getId()));
	}
}