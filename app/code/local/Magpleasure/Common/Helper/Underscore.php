...
/**
 * Native version of Underscore port from JS
 * We've just changed name to make it possible
 * to use it inside Magento as a helper.
 *
 * @source https://github.com/brianhaveri/Underscore.php
 *
 * Class Magpleasure_Common_Helper_Underscore
 */

function ___($item=null) {
    $__ = new Magpleasure_Common_Helper_Underscore;
