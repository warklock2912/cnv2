  ...
  protected function _prepareLayout() {
    ...
    public function __construct() {
        ...
        if ($this->_getId()) {
            ...
            $this->addButton('resend_notification', array(
                'title' => $this->_helper()->__("Resend Notification"),
                'label' => $this->_helper()->__("Resend Notification"),
                'onclick' => "resend_noti();",
                'class' => 'resend_noti',
            ), 1, 4);

            $resendUrl = $this->getUrl('*/*/resendNotification', $params);
            $resendUrlMessage = $this->_helper()->__("Please confirm resend notification.");
            ...
            $this->_formScripts[] = "
                ...
                function resend_noti(){
                    if (confirm('{$resendUrlMessage}')){
