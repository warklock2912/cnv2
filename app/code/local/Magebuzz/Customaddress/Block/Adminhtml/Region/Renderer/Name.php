<?php 
class Magebuzz_Customaddress_Block_Adminhtml_Region_Renderer_Name extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action {
	public function render(Varien_Object $row) {
		...
		foreach ($locales as $locale) {
				$name = isset($arr[$locale]) ? $arr[$locale] : '';
				if (!$name) {
						$name = 'EMPTY';
				}
