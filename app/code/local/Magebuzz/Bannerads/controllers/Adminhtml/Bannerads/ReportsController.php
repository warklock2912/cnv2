...
class Magebuzz_Bannerads_Adminhtml_Bannerads_ReportsController extends Mage_Adminhtml_Controller_action {
  ...
  public function gridAction() {
    $this->loadLayout();
    $this->getResponse()->setBody($this->getLayout()->createBlock('bannerads/adminhtml_reports_grid')->toHtml());
  }

  public function exportCsvAction() {
    $fileName = 'bannerads.csv';
    $content = $this->getLayout()->createBlock('bannerads/adminhtml_reports_grid')->getCsv();
  ...
  public function exportXmlAction() {
    ...
    $content = $this->getLayout()->createBlock('bannerads/adminhtml_reports_grid')->getXml();
