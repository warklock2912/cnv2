 ...
 */
class Amasty_Groupcat_Model_Htmlprocessor_Zendquery
    extends Zend_Dom_Query
    implements Amasty_Groupcat_Model_Htmlprocessor_Interface
{
    protected $_processorName = 'amgroupcat/htmlprocessor_zendquery';
