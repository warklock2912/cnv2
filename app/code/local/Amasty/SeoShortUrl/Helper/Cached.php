...
class Amasty_SeoShortUrl_Helper_Cached extends Mage_Core_Helper_Abstract
{
    const CACHE_TAG = 'amseoshorturl';

    private $lightCache = array();

    public function invalidateCache()
    {
        Mage::app()->getCacheInstance()->invalidateType('amseoshorturl');
    }
    ...
    private function makeCacheKey($key)
    {
        ...
        return 'amseoshorturl_ ' . $isSearch . '_store' . $storeId . '_' . $key;
    }
