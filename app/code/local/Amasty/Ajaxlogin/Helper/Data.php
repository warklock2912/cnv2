   ...
   public function getCustomerBySocialId($name, $value)
    ...
    )
    {
        ...
        $customer->setEmail($email)
                ...
                ->setData('vip_member_id', Mage::getModel('Marginframe_Apiregister_Model_Observer')->getnewcustomercode())
                ->setData('vip_member_status', 1)
                ->setPassword($customer->generatePassword(10));

        $customer->setConfirmation(null);
        $customer->save();
        Mage::dispatchEvent('customer_facebook_register_success', array(
            'customer'  => $customer,
        ));
