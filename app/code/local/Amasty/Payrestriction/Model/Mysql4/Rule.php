 ...
 */ 
class Amasty_Payrestriction_Model_Mysql4_Rule extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('ampayrestriction/rule', 'rule_id');
    }
    ...
    public function getAttributes()
    {
        ...
        $tbl   = $this->getTable('ampayrestriction/attribute');
