...
class Amasty_Shopby_Block_Adminhtml_Value_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function prepareFieldsetNavigation()
    {
      ...
      $fldNav->addField('img_share', 'file', array(
        'label'     => $this->__('Share Image'),
        'name'      => 'img_share',
        'required'  => false,
        'after_element_html' => $this->getImageHtml($this->model->getImgShare()),
      ));
      $fldNav->addField('remove_img_share', 'checkbox', array(
        'label'     => $this->__('Remove share Image'),
        'name'      => 'remove_img_share',
        'value'     => 1,
      ));
    }
