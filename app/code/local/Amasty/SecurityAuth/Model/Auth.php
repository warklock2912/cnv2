...
class Amasty_SecurityAuth_Model_Auth extends Mage_Core_Model_Abstract
{
    ...
    {
        $urlencoded = urlencode('otpauth://totp/'.$this->getStoreName().'?secret='.$secret);
     ...
     *
     * @param int $length
     * @return Amasty_SecurityAuth_Model_Auth
     */
    ...
    {
        $username = Mage::getModel('admin/user')->load($this->getId())->getUsername();
