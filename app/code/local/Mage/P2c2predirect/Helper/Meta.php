...
class Mage_P2c2predirect_Helper_Meta extends Mage_Core_Helper_Abstract
{
    public function p2c2predirect_meta($request)
    {
        $customer_id = Mage::getSingleton('customer/session')->getId();

        $model = Mage::getModel('p2c2predirect/meta');
