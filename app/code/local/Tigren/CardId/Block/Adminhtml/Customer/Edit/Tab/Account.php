 ...
 */
class Tigren_CardId_Block_Adminhtml_Customer_Edit_Tab_Account extends Mage_Adminhtml_Block_Customer_Edit_Tab_Account
{
    /**
     * Initialize block
     */
...
//        $fieldset->addField('card_id', 'text',
//            array(
//                'label' => Mage::helper('customer')->__('ID Card'),
//                'class' => 'input-text',
//                'name'  => 'card_id',
//                'required' => false,
//            )
//        );
//        if ($customer->getId()){
//            $customerCardNumbers = $this->getCustomerFromCardTable($customer->getId());
//            if ($customerCardNumbers['customer_id'] == $customer->getId()){
//                $customerData['card_id'] = $customerCardNumbers['card_id'];
//            }
//            else{
//                $customerData['card_id'] = '';
//            }
//        }
    ...
    public function getCustomerFromCardTable($customerId){
        $resource = Mage::getSingleton('core/resource');
        $readConnection = $resource->getConnection('core_read');
        $writeConnection = $resource->getConnection('core_write');
        $customerCardTable   = $resource->getTableName('crystal_card_id');
        $select = $readConnection->select()
            ->from($customerCardTable)
