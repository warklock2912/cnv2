...
class Tigren_Ruffle_Block_Adminhtml_Ruffle_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('is_pickup', 'select', array(
            'label'     => Mage::helper('ruffle')->__('Pickup'),
            'title'     => Mage::helper('ruffle')->__('Pickup'),
            'name'      => 'is_pickup',
            'required' => true,
            'options'    => array(
                '1' => Mage::helper('ruffle')->__('Yes'),
                '0' => Mage::helper('ruffle')->__('No'),
            ),
        ));
        ...
        $fieldset->addField('is_invoice', 'select', array(
            'label' => Mage::helper('ruffle')->__('Doc/ Invoice'),
            'title' => Mage::helper('ruffle')->__('Doc/ Invoice'),
            'name' => 'is_invoice',
            'required' => true,
            'options' => array(
                '1' => Mage::helper('ruffle')->__('Active'),
        ...
        $fieldset->addField('use_creditcard', 'select', array(
            'label' => Mage::helper('ruffle')->__('Allow to choose Credit Card'),
            'title' => Mage::helper('ruffle')->__('Allow to choose Credit Card'),
            'name' => 'use_creditcard',
            'required' => true,
            'options' => array(
                '1' => Mage::helper('ruffle')->__('Yes'),
