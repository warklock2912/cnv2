...
class Tigren_Ruffle_Block_Adminhtml_Ruffle_Edit_Tab_Winner extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('msg', array(
            'header' => Mage::helper('ruffle')->__('Note'),
            'index' => 'msg',
        ));

        $this->addColumn('customer_ruffle_address', array(
            'header' => Mage::helper('ruffle')->__('Address'),
        ...
        $this->addColumn('action', array(
            ...
            'sortable' => false,
            'is_system' => true,
            'renderer' => 'Tigren_Ruffle_Block_Adminhtml_Ruffle_Edit_Renderer_Action',
        ));

        $this->addColumn('change_to_loser', array(
            'header' => Mage::helper('ruffle')->__('Change to loser'),
            'index' => 'action',
            'width' => '170',
            'filter' => false,
            'sortable' => false,
            'is_system' => true,
            'renderer' => 'Tigren_Ruffle_Block_Adminhtml_Ruffle_Edit_Renderer_Unassign',
        ));
