        ...
        if (!isset($this->joinedTables[$tableName])) {
            ...
            $this->getSelect()->joinLeft(
                array($tableName => new Zend_Db_Expr(
                    '(SELECT GROUP_CONCAT(CONCAT_WS("^", product_id, product_type, name, sku, qty_ordered, parent_item_id) SEPARATOR "@") as products, order_id FROM '.$orderItemTable. ' GROUP BY order_id)'
                )),
