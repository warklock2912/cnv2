 ...
 */
class Bubble_DynamicCategory_Model_Rule_Condition_Product extends Mage_CatalogRule_Model_Rule_Condition_Product
{
    ...
    public function getDefaultOperatorOptions()
    {
        ...
        $options['^$']  = Mage::helper('dynamic_category')->__('matches regexp');
        $options['!^$'] = Mage::helper('dynamic_category')->__('does not match regexp');
