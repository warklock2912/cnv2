 ...
 */
class Bubble_DynamicCategory_Model_Rule_Condition_Product_New
    extends Bubble_DynamicCategory_Model_Rule_Condition_Product_Boolean
{
    protected function _construct()
    {
        parent::_construct();
        $this->setType('product_is_new');
        $this->setValueName('Is New');
    }

    public function getAttributeName()
    {
        return Mage::helper('dynamic_category')->__('Is New');
    }
