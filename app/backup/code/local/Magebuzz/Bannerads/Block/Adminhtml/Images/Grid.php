	...
	*/
	...
	class Magebuzz_Bannerads_Block_Adminhtml_Images_Grid extends Mage_Adminhtml_Block_Widget_Grid
	{
		...
		protected function _prepareColumns()
		{
			...
			$this->addColumn('banner_image', array('header' => Mage::helper('bannerads')->__('Image'), 'index' => 'banner_image', 'align' => 'center', 'filter' => false, 'renderer' => 'Magebuzz_Bannerads_Block_Adminhtml_Images_Renderer_Images'));
			$this->addColumn('start_time', array(
			 'header' => Mage::helper('bannerads')->__('Start Time'),
			 'width' => '150px',
			 'gmtoffset' => true,
			 'type' => 'datetime',
			 'index' => 'start_time',
			...
			$this->addColumn('end_time', array(
			 'header' => Mage::helper('bannerads')->__('End Time'),
			 'width' => '150px',
			 'type' => 'datetime',
			 'gmtoffset' => true,
			 'index' => 'end_time',
