...
*/
class Magebuzz_Customaddress_Block_Adminhtml_Subdistrict_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
	...
	public function getHeaderText() {
		if( Mage::registry('subdistrict_data') && Mage::registry('subdistrict_data')->getId() ) {
			return Mage::helper('customaddress')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('subdistrict_data')->getDefaultName()));
		} else {
