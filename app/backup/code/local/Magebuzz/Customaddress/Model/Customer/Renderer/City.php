<?php
class Magebuzz_Customaddress_Model_Customer_Renderer_City implements Varien_Data_Form_Element_Renderer_Interface
{
  ...
  public function render(Varien_Data_Form_Element_Abstract $element)
  {
    ...
    if ($regionId) {
      if (!isset(self::$_cityCollections[$regionId])) {
        self::$_cityCollections[$regionId] = Mage::getModel('customaddress/city')
					->getCollection()
