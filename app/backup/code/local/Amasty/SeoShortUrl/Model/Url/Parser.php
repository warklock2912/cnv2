...
class Amasty_SeoShortUrl_Model_Url_Parser
{
    /** @var  string */
    protected $params;
    ...
    public function parseParams($params)
    {
        ...
        if ($this->params == Mage::getStoreConfig('amseoshorturl/seo/key')) {
            return array();
        }
    ...
    protected function prepareInitialData($params)
    {
        ...
        $optionChar = Mage::getStoreConfig('amseoshorturl/seo/option_char');
        if ($optionChar == '--') {
