    ...
    public function forgotPasswordPostAction()
    {
        ...
        if (!$customer->getId()) {
            $this->_getSession()->addError(
                $this->__(
                    'The customer, that associated with this value, was not found in our records.'
                )
            );
        ...
        try {
            ...
            $this->_getSession()->addSuccess(
                $this->__(
                    'Forgot password email has been sent to the email address that you used for registration.'
                )
            );
