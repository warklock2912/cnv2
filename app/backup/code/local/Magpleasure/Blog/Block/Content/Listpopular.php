...
class Magpleasure_Blog_Block_Content_Listpopular extends Magpleasure_Blog_Block_Content_Abstract
{
  ...
  protected function _prepareLayout()
  {
    ...
    if(Mage::registry('currentNumberPostPopular')){
      $limit += Mage::registry('currentNumberPostPopular');
    }
    $this->getToolbar()
...
//      $collection->setDateOrder();
  ...
  public function getTotalPostPopular(){
    $collection = Mage::getModel('mpblog/post')->getCollection();
    if (!Mage::app()->isSingleStoreMode()){
      $collection->addStoreFilter(Mage::app()->getStore()->getId());
    }
