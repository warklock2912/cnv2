 ...
 */
class Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_OrderItems extends Magestore_Pdfinvoiceplus_Block_Adminhtml_Configurations_Checkbox
{
    /**
     * Options getter
     *
    ...
    public function toOptionArray() {
        ...
        $all_var = $var_model->getAllVars_Order_Items();
        $onHiden_Var = $var_model->getVarsOnHiden_Order_Items();
        $mathVar = array();
