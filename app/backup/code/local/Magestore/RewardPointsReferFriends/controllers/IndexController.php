...
class Magestore_RewardPointsReferFriends_IndexController extends Mage_Core_Controller_Front_Action {
    ...
    public function gmailAction() {
        ...
        if (!Mage::Helper('customer')->isLoggedIn()) {
            ...
            $this->getResponse()->setBody("<html><head></head><body><script type='text/javascript'>
				try{
    ...
    public function facebookAction() {
        ...
        try {
            ...
            $this->getResponse()->setBody("<script type='text/javascript'>window.opener.document.getElementById('referfriends-facebook-msg').show();
                window.close();</script>");
            exit();
        } catch (Exception $e) {
            $this->getResponse()->setBody("<script type='text/javascript'>window.opener.document.getElementById('referfriends-facebook-msg-fail').show();
                window.close();</script>");
        }
        $this->getResponse()->setBody("<script type='text/javascript'>window.opener.document.getElementById('referfriends-facebook-msg-fail').show();
            window.close();</script>");
