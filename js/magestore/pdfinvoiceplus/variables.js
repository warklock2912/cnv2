...
var Variables = {
    ...
    init: function(textareaElementId, insertFunction, type) {
        ...
        if(type)
            this.dialogWindowId = 'variables-chooser-'+type;
    },
...
MagentovariablePlugin = {
    ...
    loadChooser: function(url, textareaId, type) {
        this.textareaId = textareaId;
            new Ajax.Request(url, {
                parameters: {},
                onComplete: function (transport) {
                    if (transport.responseText.isJSON()) {
                        Variables.init(null, 'MagentovariablePlugin.insertVariable', type);
