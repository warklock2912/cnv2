var text_title_color; //global variable
...
function updateTitle(color) {
    ...
    $(".title-color").css("color", hexColor);
    $(".label").css("color", hexColor);
    $(".order1").css("color", hexColor);
    $(".title1").css("color", hexColor);
    
    text_title_color = hexColor;
}

$(function() {
var color_title = $('.title-color').css('color');
$("#change-title").spectrum({
    allowEmpty:true,
//    color: "#ECC",
    color: color_title,
    showInput: true,
...
$(".basic").spectrum({ change: updateTitle });
$(".override").spectrum({
    color: "yellow",
    change: updateTitle
});
