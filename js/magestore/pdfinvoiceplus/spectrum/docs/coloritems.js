var background_color; //global variable


function updateBackgroundItems(color) {
    var hexColor = "transparent";
    if(color) {
        hexColor = color.toHexString();
    }
    $(".background-items").css("background-color", hexColor);
    background_color = hexColor;
}

$(function() {
var background_items = $(".table-data tbody td").css("background-color");
$("#backgrounditems").spectrum({
    allowEmpty:true,
//    color: "#ECC",
...
$(".basic").spectrum({ change: updateBackgroundItems });
$(".override").spectrum({
    color: "yellow",
    change: updateBackgroundItems
});
