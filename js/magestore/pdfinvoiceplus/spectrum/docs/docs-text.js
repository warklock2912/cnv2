var text_color; //global variable
...
function updateText(color) {
    ...
    $(".header-color").css("color", hexColor);
    $(".content").css("color", hexColor);
    $(".value-variable").css("color", hexColor);
    $(".note").css("color", hexColor);
    $(".totals").css("color", hexColor);
    $(".footer-invoice").css("color", hexColor);
    $(".top-text").css("color", hexColor);
    $(".block-add").css("color",hexColor);
    $(".color-text").css("color",hexColor);
    $(".footer-text").css("color", hexColor);
    $(".text").css("color", hexColor);
    text_color = hexColor;
}

$(function() {
var color_text = $(".content").css("color");
$("#change-text").spectrum({
    allowEmpty:true,
    //    color: "#ECC",
    color: color_text,
    showInput: true,
...
$(".basic").spectrum({ change: updateText });
$(".override").spectrum({
    color: "yellow",
    change: updateText
});
