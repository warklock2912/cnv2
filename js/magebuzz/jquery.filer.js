            ...
            create: function (i) {
              ...
              var file = f.files[i],
                ...
                opts = {
                  ...
                  image: '<div class="jFiler-item-thumb-image fi-loading" id="' + id + '" onclick="setTemplateNew(this.id)" data="' + f.files[i].name + '"  ></div>',
            ...
            _box: function (params) {
              ...
              if (l.length < 1) {
                ...
                appendTo.find('.jFiler-items')
                  .remove();
                l = $('<div class="jFiler-items jFiler-row clear"></div>');
                s.prop("jFiler").listEl = l;
                ...
                if (item.file._choosed || item.file._appended || item.uploaded) {
                  ...
                  if (n.addMore) {
                    ...
                    f._itFl.filter(function (val, index) {
                      if (val.file._choosed && val.input.get(0) == current_input.get(0))
                        count_same_input++;
                    });
