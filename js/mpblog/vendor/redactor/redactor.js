...
(function($)
{
	...
	$.Redactor.opts = {
		...
		autosaveOnChangeInterval: 300, // miliseconds
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		autosave: function()
		{
			return {
				...
				{
					if (!this.opts.autosaveOnChange) return;
                    if (this.autosaveOnChangeTimeout){
                        clearTimeout(this.autosaveOnChangeTimeout);
                    }

                    this.autosaveOnChangeTimeout = setTimeout($.proxy(this.autosave.load, this), this.opts.autosaveOnChangeInterval);
				},
				load: function()
				{
