var background_title_color; //global variable
...
function updateBorders(color) {
    ...
    $(".title").css("background-color", hexColor);
    $(".bg").css("background-color", hexColor);
    $(".header-content").css("border-bottom-color", hexColor);
    $(".color-theme").css("background-color", hexColor);
    $(".title-page-iv").css("background-color", hexColor);
    $(".label").css("background-color", hexColor);
    $(".content").css("border-color", hexColor);
//    $(".list-detail").css("border-bottom-color", hexColor);
    $("items-color").css("border-bottom-color", hexColor);
//    $(".list-detail").css("background-color", hexColor);
    $("#invoice-color").css("color", hexColor);
    $(".footer-order").css("background-color", hexColor);
    
    $(".color-theme-text").css("color", hexColor);
    $(".top-header-iv").css("border-bottom-color", hexColor);
//    $(".footer-order").css("background-color", hexColor);
    $(".color-theme-top").css("border-top-color", hexColor);
    $(".color-theme-bottom").css("border-bottom-color", hexColor);
//    $(".bottom-color").css("border-bottom-color", hexColor);
    $(".bottom-color").css("border-bottom-width",'8px');
    $(".bottom-color").css("border-bottom-style",'solid');
    $(".bottom-color").css("border-bottom-color",hexColor);
    $(".arrow").css("border-left-width",'14px');
    $(".arrow").css("border-left-style",'solid');
    $(".arrow").css("border-left-color",hexColor);

    //thin custom
    $(".style-border-color").css("border-color", hexColor);
    $(".style-color").css("background-color", hexColor);
    $(".style-color").css("border-color", hexColor);
    
    background_title_color = hexColor;
}

$(function() {
var background_title = $(".title").css("background-color");
$("#full").spectrum({
    allowEmpty:true,
//    color: "#ECC",
    color: background_title,
    showInput: true,
